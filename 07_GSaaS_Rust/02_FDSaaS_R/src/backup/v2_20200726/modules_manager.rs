...
impl ModuleManager
{
   ...
   pub async fn load_module_definitions(&self) -> std::result::Result<(), String> 
   {
      ...
      {
         let tmp_pull_port = tmp_config_data.modules_base_pull_port.trim().parse::<u32>().expect("Incorrect PULL base port number");
