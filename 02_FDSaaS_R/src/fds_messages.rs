...
impl RestResponse {
    ...
    pub fn new_value(in_msg_code: &str, in_msg_id : String, in_value: Value) -> Self {
        RestResponse {
            msg_id :         in_msg_id.clone(),
            msg_code_id:     String::from(in_msg_code),
            result:          in_value,
            error:           None,
        }
    }

    pub fn new_error_msg(in_msg_code: &str, in_msg_id : String, in_error_msg: String) -> Self {
        RestResponse {
            msg_id :         in_msg_id.clone(),
            msg_code_id:     String::from(in_msg_code),
            result:          Value::Null,
    ...
    pub fn new_error_id(in_msg_code: &str, in_msg_id : String, in_error_code: i32, in_error_msg: String) -> Self {
        RestResponse {
            msg_id :         in_msg_id.clone(),
            msg_code_id:     String::from(in_msg_code),
            result:          Value::Null,
...
impl InternalResponseMessage {
    ...
    pub fn new_error(in_msg_code_id: &str, in_msg_id: String, in_error_str: &str, in_execution_id: u32) -> Self {  
        InternalResponseMessage {
            response:      RestResponse::new_error_msg(in_msg_code_id, in_msg_id, String::from(in_error_str)),
            execution_id:  in_execution_id,
            wait_flag:     false,
        }
    }

    pub fn new_error_ext(in_msg_code_id: &str, in_msg_id: String, in_error_code : i32, in_error_str: &str, in_execution_id: u32) -> Self {   
        InternalResponseMessage {
            response:      RestResponse::new_error_id(in_msg_code_id, in_msg_id, in_error_code, String::from(in_error_str) ),
            execution_id:  in_execution_id,
            wait_flag:     false,
        }
    }

    pub fn new_value(in_msg_code_id: &str, in_msg_id: String, in_value: Value, in_execution_id: u32) -> Self {
        InternalResponseMessage {
            response:      RestResponse::new_value(in_msg_code_id, in_msg_id, in_value),
            execution_id:  in_execution_id,
            wait_flag:     false,
        }
    }

    pub fn new_wait(in_msg_code_id: &str, in_msg_id: String, in_execution_id: u32) -> Self {
        InternalResponseMessage {
            response:      RestResponse::new_value(in_msg_code_id, in_msg_id, Value::Null),
            execution_id:  in_execution_id,
            wait_flag:     true,
        }
    }
