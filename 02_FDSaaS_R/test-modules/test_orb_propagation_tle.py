...
class TestOrbPropagation(unittest.TestCase):
    ...
    def test_orb_propagate_tle(self):
        global user_id, authentication_key

        print("Test Orbit Propagation TLE  ......")
        # LANDSAT 7
        api_url = API_SERVER_IP + "fdsaas/api/orb_propagation_tle"
    ...
    def test_orb_propagate_tle_usage(self):
        global user_id, authentication_key

        print("Test Orbit Propagation TLE Usage  ......")
        api_url = API_SERVER_IP + "fdsaas/api/orb_propagation_tle/usage"
