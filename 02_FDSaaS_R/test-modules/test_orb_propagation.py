...
class TestOrbPropagation(unittest.TestCase):
    ...
    def test_orb_propagation(self):
        global user_id, authentication_key

        print("Test Orbit Propagation  ......")
        api_url = API_SERVER_IP + "fdsaas/api/orb_propagation"
        
        with open('orb_propagation.json') as f:
             in_json = json.load(f)
    ...
    def test_orb_propagation_usage(self):
        global user_id, authentication_key

        print("Test Orbit Propagation TLE Usage  ......")
        api_url = API_SERVER_IP + "fdsaas/api/orb_propagation/usage"
